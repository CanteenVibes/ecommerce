...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Carrinho || Cantee Vibes</title>
    ...
    <div class="row" style="margin-top:10px;">
      <div class="large-12">
        <?php
          ...
          echo '<tr>';
          echo '<td colspan="4" align="right"><a href="update-cart.php?action=empty" class="button alert">Excluir do carrinho -</a>&nbsp;<a href="products.php" class="button [secondary success alert]">Continuar comprando < </a>';
          if(isset($_SESSION['username'])) {
          ...
          echo "Não possuem itens no seu carrinho.";
        }
    ...
    <div class="row" style="margin-top:10px;">
      <div class="small-12">
        ...
        <footer style="margin-top:10px;">
           <p style="text-align:center; font-size:0.8em;clear:both;">Todos os direitos reservados Canteen Vibes &copy; 2022.</p>
        </footer>

...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Minha Conta || Canteen Vibes</title>
  ...
  <nav class="top-bar" data-topbar role="navigation">
      <ul class="title-area">
        <li class="name">
          <h1><a href="index.php">Cantten Vibes</a></h1>
        </li>
        ...
        <div class="small-12">
            ...
            <div class="small-8 columns end">
              <?php
                ...
                if($result) {
                  ...
                  echo '<label for="right-label" class="right inline">Sobrenome</label>';
                  echo '</div>';
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              ...
              <input type="reset" id="right-label" value="Limpar" style="background: #0078A0; border: none; color: #fff; font-family: 'Helvetica Neue', sans-serif; font-size: 1em; padding: 10px;">
            </div>
          </div>
        </div>
      </div>
